...
def myPages(canvas, doc): 
    ...
    canvas.drawRightString(pageWidth-0.6*inch, 1.32*inch, "%s" % (longStr)) 
    canvas.setFont('Helvetica',10) 
    canvas.drawRightString(pageWidth-0.6*inch, 1.45*inch, "%s" % (longStr)) 
    canvas.setFont('Helvetica',12) 
    canvas.drawRightString(pageWidth-0.6*inch, 1.60*inch, "%s" % (longStr)) 
    canvas.setFont('Helvetica',14) 
    canvas.drawRightString(pageWidth-0.6*inch, 1.770*inch, "%s" % (longStr)) 
    canvas.setFont('Helvetica',6) 

    # Text scale text labels
    canvas.setFillColor('#303030') 
    canvas.drawString(pageWidth-0.55*inch, 1.275*inch, "%d" % (0)) 
    canvas.drawString(pageWidth-0.55*inch, 1.405*inch, "%d" % (25)) 
    canvas.drawString(pageWidth-0.55*inch, 1.550*inch, "%d" % (50)) 
    canvas.drawString(pageWidth-0.55*inch, 1.715*inch, "%d" % (75)) 
    canvas.drawString(pageWidth-0.55*inch, 1.905*inch, "%d" % (100)) 
    canvas.drawString(pageWidth-0.715*inch, 2.02*inch, "%s" % ('Long %')) 

    # Text scale label ticks
    canvas.setLineWidth(0.5) 
    canvas.setStrokeColor('#707070') 
    # canvas.setDash(0.5, 0.5)
    canvas.line(pageWidth-0.665*inch, 1.30*inch, pageWidth-0.57*inch, 1.30*inch) 
    canvas.line(pageWidth-0.685*inch, 1.425*inch, pageWidth-0.57*inch, 1.425*inch) 
    canvas.line(pageWidth-0.7*inch, 1.575*inch, pageWidth-0.57*inch, 1.575*inch) 
    canvas.line(pageWidth-0.715*inch, 1.745*inch, pageWidth-0.57*inch, 1.745*inch) 
    canvas.line(pageWidth-0.715*inch, 1.935*inch, pageWidth-0.57*inch, 1.935*inch) 
...
doc = SimpleDocTemplate('DocFreq_Prelim_rev5c.pdf', pagesize = letter)
